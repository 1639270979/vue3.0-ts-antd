  ...
  >
    ...
    <div class="ant-color-picker__trigger" @click="handleTrigger">
      <span class="el-color-picker__color" :class="{ 'is-alpha': showAlpha }">
        ...
        >
          <down-outlined v-show="modelValue || showPanelColor" style="color: #909399" />
          <close-outlined v-if="!modelValue && !showPanelColor" style="color: #909399" />
        </span>
      </span>
    </div>
  </a-popover>
...
<script lang="ts">
// https://gitee.com/ghkeeping/ant-color-picker // 颜色选择器源码地址
...
export default defineComponent({
  ...
  props: {
    ...
    predefine: {
      type: Array,
      default: () => ['#1890ff', '#F5A623', '#F8E71C', '#8B572A', '#7ED321',
  ...
  setup(props, { emit }) {
    ...
    // methods
    function displayedRgb(color:any, showAlpha:any) {
    ...
    function setShowPicker(value:any) {
